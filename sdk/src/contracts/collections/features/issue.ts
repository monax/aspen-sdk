...
export class Claim extends FeatureSet<ClaimFeatures> {
  ...
  async issue(
    ...
    throw new SdkError(SdkErrorCode.UNSUPPORTED_TOKEN_STANDARD, {
  ...
  async parseClaimReceipt(receipt: ContractReceipt): Promise<TokenAssetMetadata[]> {
    ...
    const chainId = await this.base.chainId;
    ...
    try {
      ...
      throw new SdkError(SdkErrorCode.INVALID_DATA, { receipt });
    }
