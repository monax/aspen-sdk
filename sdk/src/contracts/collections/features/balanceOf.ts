...
const BalanceOfPartitions = {
  nft: [...FeatureFunctionsMap['balanceOf(address)[uint256]'].drop],
  sft: [...FeatureFunctionsMap['balanceOf(address,uint256)[uint256]'].drop],
};
...
> {
  ...
  constructor(base: CollectionContract) {
    super(base, BalanceOfInterfaces, BalanceOfPartitions);
  }
